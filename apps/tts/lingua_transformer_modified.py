...
class TransformerBlock(nn.Module):
    def __init__(self, args: BaseTransformerArgs):
        ...
        self.head_dim = args.head_dim or args.dim // cast(int, args.n_heads)
        self.n_heads = args.n_heads or args.dim // cast(int, args.head_dim)
        self.n_kv_heads = args.n_kv_heads or self.n_heads

        assert cast(int, args.n_heads) % cast(int, self.n_kv_heads) == 0
        assert args.dim % cast(int, args.n_heads) == 0
